Contributing to BlockidCoin Core
============================

The BlockidCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/blockidcoin-project/blockidcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BlockidCoin Core project, and is not to be
confused with overall BlockidCoin Network Protocol consensus changes.

Whether a pull request is merged into BlockidCoin Core rests with the project merge
...
Patches that change BlockidCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the BlockidCoin consensus, it must have been
...
The project leader is the release manager for each BlockidCoin Core release.
