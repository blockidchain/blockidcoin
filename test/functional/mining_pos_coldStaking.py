...
from test_framework.blockidcoin_node import BlockidCoinTestNode
...
class BlockidCoin_ColdStakingTest(BlockidCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(BlockidCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 BID from the pot)
...
if __name__ == '__main__':
    BlockidCoin_ColdStakingTest().main()
