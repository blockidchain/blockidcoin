...
class RawTransactionsTest(BlockidCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid blockidcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid blockidcoin address" in e.error['message'])
