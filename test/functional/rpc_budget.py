...
class BudgetProposalTest(BlockidCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid BlockidCoin address")
        assert_raises_rpc_error(-5, "Invalid BlockidCoin address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 BID allowed", self.nodes[0].preparebudget,
