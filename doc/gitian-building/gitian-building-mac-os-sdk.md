...
The script [extract-osx-sdk.sh](https://github.com/blockidcoin-project/blockidcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
blockidcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/blockidcoin-project/blockidcoin/blob/master/doc/README_osx.md) for troubleshooting tips.