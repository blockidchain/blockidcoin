...
/** 
    ...
    ****Note - for BlockidCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of blockidcoin coming in to a transaction
