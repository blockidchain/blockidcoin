...
#include "qt/blockidcoin/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BID</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
...
{
    BlockidCoinGUI* gui = static_cast<BlockidCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<BlockidCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BlockidCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BIDs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
