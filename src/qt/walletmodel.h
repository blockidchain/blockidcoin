...
#ifndef BlockidCoin_QT_WALLETMODEL_H
#define BlockidCoin_QT_WALLETMODEL_H
...
/** Interface to BlockidCoin wallet from Qt view code. */
...
#endif // BlockidCoin_QT_WALLETMODEL_H
