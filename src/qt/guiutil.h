...
/** Utility functions used by the BlockidCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BlockidCoin addresses in monospace font
...
// Parse "blockidcoin:" URI into recipient object, return true on successful parsing
