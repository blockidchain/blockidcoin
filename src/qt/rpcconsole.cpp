                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBIDPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzBIDPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzBIDPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBIDPathCustom.empty()) && nCustomBackupThreshold > 0) {
