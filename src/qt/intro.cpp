...
bool Intro::pickDataDirectory()
{
	...
	intro.fillMnemonicSeed();
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BlockidCoin Core"),
     ...
     * override -datadir in the blockidcoin.conf file in the default data directory
     * (to be consistent with blockidcoind behavior)
     */
