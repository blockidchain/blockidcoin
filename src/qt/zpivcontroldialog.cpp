// Copyright (c) 2017-2020 The BlockidCoin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zBID Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zBID.";
            else if (!mint.isSeedCorrect)
                strReason = "The zBID seed used to mint this zBID is not the same as currently hold in the wallet";
            else
