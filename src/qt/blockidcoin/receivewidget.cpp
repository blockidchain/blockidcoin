...
#include "qt/blockidcoin/forms/ui_receivewidget.h"
...
#include "qt/blockidcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BlockidCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive BID."));
