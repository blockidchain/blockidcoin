...
#include "qt/blockidcoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(BlockidCoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-blockidcoin");
