...
#include "qt/blockidcoin/coldstakingwidget.h"
#include "qt/blockidcoin/forms/ui_coldstakingwidget.h"
#include "qt/blockidcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/blockidcoin/requestdialog.h"
#include "qt/blockidcoin/tooltipmenu.h"
...
#include "qt/blockidcoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(BlockidCoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your BIDs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept BID delegation / Delegate BID"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select BID outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 BID" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
