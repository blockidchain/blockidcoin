...
#include "qt/blockidcoin/coincontrolpivwidget.h"
#include "qt/blockidcoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select BID Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("BID");
    ...
    ui->labelValueAfter->setText("0.00 BID");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 BID");
    ui->labelValueFee->setText("0.00 BID");
