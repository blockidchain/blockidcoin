...
#ifndef BlockidCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BlockidCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BlockidCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
