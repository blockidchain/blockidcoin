...
#include "qt/blockidcoin/forms/ui_addresseswidget.h"
#include "qt/blockidcoin/addresslabelrow.h"
#include "qt/blockidcoin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(BlockidCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter BlockidCoin address"));
