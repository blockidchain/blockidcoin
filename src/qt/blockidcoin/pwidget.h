...
#include <QWidget>
#include <QString>
#include "qt/blockidcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(BlockidCoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    BlockidCoinGUI* getWindow() { return this->window; }
