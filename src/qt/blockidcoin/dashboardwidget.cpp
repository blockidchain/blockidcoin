...
#include "qt/blockidcoin/forms/ui_dashboardwidget.h"
#include "qt/blockidcoin/sendconfirmdialog.h"
#include "qt/blockidcoin/txrow.h"
...
DashboardWidget::DashboardWidget(BlockidCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of BID staked."));
    ...
    ui->labelAmountPiv->setText("0 BID");
    ...
    ui->btnHowTo->setText(tr("How to get BID"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("BID")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZBID;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair BID, zBID
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("BID");
    set1 = new QBarSet("zBID");
