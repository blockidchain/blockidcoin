...
#include "qt/blockidcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/blockidcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BlockidCoinGUI* _window, QWidget *parent) :
