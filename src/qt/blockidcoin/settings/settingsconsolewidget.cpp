...
#include "qt/blockidcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/blockidcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BlockidCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the BlockidCoin RPC console.") + "<br>" +
