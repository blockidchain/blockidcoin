...
#include "qt/blockidcoin/settings/settingsnetworkwidget.h"
#include "qt/blockidcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/blockidcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BlockidCoinGUI* _window, QWidget *parent) :
