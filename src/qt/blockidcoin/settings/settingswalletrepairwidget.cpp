...
#include "qt/blockidcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/blockidcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BlockidCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BlockidCoinGUI::handleRestart()
