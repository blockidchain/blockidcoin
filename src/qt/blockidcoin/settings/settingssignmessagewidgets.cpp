...
#include "qt/blockidcoin/settings/settingssignmessagewidgets.h"
#include "qt/blockidcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BlockidCoinGUI* _window, QWidget *parent) :
