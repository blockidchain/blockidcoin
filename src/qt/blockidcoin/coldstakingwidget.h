...
#include "qt/blockidcoin/furabstractlistitemdelegate.h"
#include "qt/blockidcoin/txviewholder.h"
#include "qt/blockidcoin/tooltipmenu.h"
#include "qt/blockidcoin/sendmultirow.h"
#include "qt/blockidcoin/coldstakingmodel.h"
#include "qt/blockidcoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(BlockidCoinGUI* parent);
    ~ColdStakingWidget();
