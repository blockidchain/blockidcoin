...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BlockidCoin Core blockidcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blockidcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blockidcoin transaction") + "\n" +
                               "  blockidcoin-tx [options] -create [commands]   " + _("Create hex-encoded blockidcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blockidcoin transaction
