// Copyright (c) 2017-2018 The BlockidCoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BlockidCoin_ZBIDWALLET_H
#define BlockidCoin_ZBIDWALLET_H
...
public:
    CzBIDWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBID(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBID(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BlockidCoin_ZBIDWALLET_H
