...
#ifndef BlockidCoin_ZBIDTRACKER_H
#define BlockidCoin_ZBIDTRACKER_H
...
public:
    CzBIDTracker(std::string strWalletFile);
    ~CzBIDTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBIDWallet* zBIDWallet = NULL);
...
#endif //BlockidCoin_ZBIDTRACKER_H
