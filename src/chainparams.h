 ...
 * BlockidCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int BlockidCoinBadBlockTime() const { return nBlockidCoinBadBlockTime; }
    int BlockidCoinBadBlocknBits() const { return nBlockidCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nBlockidCoinBadBlockTime;
    unsigned int nBlockidCoinBadBlocknBits;
